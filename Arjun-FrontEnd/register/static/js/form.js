...
var url = ""; //The URL to which the AJAX request is sent must go here.
...
function updateEventsInDatabase(url,argumentString) {
	...
	xhttp.open("POST", url+"?"+argumentString, true);
	xhttp.send();
